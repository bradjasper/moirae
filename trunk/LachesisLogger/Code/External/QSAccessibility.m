...
void QSEnableAccessibility() {
  ...
  myStatus = AuthorizationExecuteWithPrivileges([auth authorizationRef],
                                                "/usr/bin/touch",
  ...
  // Notify running apps that this value has changed
  [[NSDistributedNotificationCenter defaultCenter] postNotificationName:@"com.apple.accessibility.api" object:nil];
}
